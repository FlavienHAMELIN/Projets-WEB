 ...
 */
@WebServlet("/Servlet_ajout_BDD")
public class Servlet_ajout_BDD extends HttpServlet 
{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("/WEB-INF/redirection.jsp").forward(request, response);
	}
